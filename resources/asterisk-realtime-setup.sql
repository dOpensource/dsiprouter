...
/* Most likely we will need to add a set_id to this table so that we can load balance between multiple PBX's */
insert into dsip_domain_mapping values (null,0,1,'','',1);
/*  Type 0=integer 2=string */
insert into domain_attrs values (null,'voipmuch.ca','dispatcher_set_id',0,'1',NOW());
insert into domain_attrs values (null,'voipmuch.ca','dispatcher_alg',0,'4',NOW());
