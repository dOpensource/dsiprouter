...
ALTER TABLE dsip_settings
  ...
  DROP SQLALCHEMY_TRACK_MODIFICATIONS,
  DROP SQLALCHEMY_SQL_DEBUG,
  MODIFY VERSION VARCHAR(32) NOT NULL,
  MODIFY KAM_DB_PASS VARBINARY(160) COLLATE 'binary' NOT NULL,
  ADD HOMER_ID                INT                             NOT NULL AFTER FLOWROUTE_API_ROOT_URL,
  ADD NETWORK_MODE            INT                             NOT NULL DEFAULT 0 AFTER HOMER_HEP_PORT,
  ADD INTERNAL_FQDN           VARCHAR(255)                    NOT NULL DEFAULT '' AFTER INTERNAL_IP6_NET,
  ADD PUBLIC_IFACE            VARCHAR(255)                    NOT NULL DEFAULT '' AFTER EXTERNAL_FQDN,
  ADD PRIVATE_IFACE           VARCHAR(255)                    NOT NULL DEFAULT '' AFTER PUBLIC_IFACE,
  ADD DSIP_CORE_LICENSE       VARBINARY(160) COLLATE 'binary' NOT NULL,
  ADD DSIP_STIRSHAKEN_LICENSE VARBINARY(160) COLLATE 'binary' NOT NULL,
  ADD DSIP_TRANSNEXUS_LICENSE VARBINARY(160) COLLATE 'binary' NOT NULL,
  ADD DSIP_MSTEAMS_LICENSE    VARBINARY(160) COLLATE 'binary' NOT NULL;
