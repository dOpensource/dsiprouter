...
### Fix Redhat python dependencies

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Mon, 16 Sep 2019 16:48:37 -0400  
> Author: Tyler Moore (tmoore@goflyball.com)  
> Committer: Tyler Moore (tmoore@goflyball.com)  
...
### Fixed the distro name so that it installed container.io package correctly

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Mon, 9 Sep 2019 19:40:47 +0000  
> Author: root (root@ip-172-31-2-91.ec2.internal)  
> Committer: root (root@ip-172-31-2-91.ec2.internal)  
...
### Fixed docker so that it installs properly on RedHat and removed pyspack library from the requirements.txt file

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Mon, 9 Sep 2019 15:47:00 +0000  
> Author: root (root@ip-172-31-59-187.ec2.internal)  
> Committer: root (root@ip-172-31-59-187.ec2.internal)  
...
### Cleaned up the script and added support for installing sngrep

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Mon, 9 Sep 2019 10:01:47 +0000  
> Author: root (root@ip-172-31-11-106.ec2.internal)  
> Committer: root (root@ip-172-31-11-106.ec2.internal)  
...
### Fixed issue with Python not working

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Mon, 9 Sep 2019 03:09:16 +0000  
> Author: root (root@ip-172-31-4-0.ec2.internal)  
> Committer: root (root@ip-172-31-4-0.ec2.internal)  
...
> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Thu, 5 Sep 2019 23:06:59 -0400  
> Author: root (root@ip-172-31-56-153.ec2.internal)  
> Committer: root (root@ip-172-31-56-153.ec2.internal)  
...
### Added Redhat 7.x support

> Branches Affected: redhat-build  
> Tags Affected:   
> Date: Thu, 5 Sep 2019 22:45:15 -0400  
> Author: root (root@ip-172-31-56-153.ec2.internal)  
> Committer: root (root@ip-172-31-56-153.ec2.internal)  
...
> Branches Affected: redhat-build,v0.523  
> Tags Affected:   
...
> Branches Affected: redhat-build,v0.522,v0.523  
...
> Branches Affected: dev,redhat-build,v0.523  
> Tags Affected:   
...
> Branches Affected: api-documentation,dev,redhat-build,v0.523  
> Tags Affected:   
...
> Branches Affected: master,redhat-build,v0.522,v0.523  
> Tags Affected:   
...
> Branches Affected: api-documentation,dev,redhat-build,v0.522,v0.523  
> Tags Affected:   
...
> Branches Affected: api-documentation,dev,master,redhat-build,v0.522,v0.523  
> Tags Affected:   
...
> Branches Affected: sysv-upstart-compat  
> Tags Affected:   
...
> Branches Affected: api-documentation,dev,master,redhat-build,sysv-upstart-compat,v0.522,v0.523  
> Tags Affected:   
...
> Branches Affected: api-documentation,dev,master,redhat-build,ssl,sysv-upstart-compat,v0.522,v0.523  
> Tags Affected:   
