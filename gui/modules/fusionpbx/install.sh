...
#        update-ca-trust extract
    ...
    openssl req -new -newkey rsa:4096 -days 3650 -nodes -x509 -subj "/C=USA/ST=MI/L=Detroit/O=dopensource.com/CN=dSIPRouter" -keyout $abspath/certs/cert.key -out $abspath/certs/cert_combined.cer
