...
from modules.api.agents.functions import addUpdateCarrierGroups, addUpdateCarriers
import settings
...
@agents.route('/api/v1/agents/<string:id>',methods=['GET'])
@agents.route('/api/v1/agents/<string:id>',methods=['DELETE'])
@api_security
def listAgentGroups():
    """
...
@agents.route('/api/v1/agents',methods=['PUT'])
@agents.route('/api/v1/agents/<string:id>',methods=['PUT'])
@agents.route('/api/v1/agents',methods=['POST'])
@api_security
def addAgent(id=None):
    """
    ================
    Response Payload
    ================
    ...
    try:
        ...
        if plugin is not None:
            ...
            if data['plugin_name'] != "":
                # Import Plugin
                from modules.api.agents.plugin.twilio.interface import init, createTrunk, createIPAccessControlList
