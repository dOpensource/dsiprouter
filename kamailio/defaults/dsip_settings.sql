...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_DSIP_CLUSTER_ID int UNSIGNED, IN NEW_DSIP_CLUSTER_SYNC tinyint(1), IN NEW_DSIP_PROTO varchar(16),
  ...
  IN NEW_KAM_CFG_PATH varchar(255), IN NEW_KAM_TLSCFG_PATH varchar(255), IN NEW_RTP_CFG_PATH varchar(255),
  IN NEW_FLT_CARRIER int, IN NEW_FLT_PBX int, IN NEW_FLT_MSTEAMS int, IN NEW_FLT_OUTBOUND int, IN NEW_FLT_INBOUND int,
  ...
  IN NEW_FLOWROUTE_API_ROOT_URL varchar(255), IN NEW_HOMER_HEP_HOST varchar(255), IN NEW_HOMER_HEP_PORT int,
  IN NEW_IPV6_ENABLED tinyint(1), IN NEW_INTERNAL_IP_ADDR varchar(255), IN NEW_INTERNAL_IP_NET varchar(255),
  IN NEW_INTERNAL_IP6_ADDR varchar(255), IN NEW_INTERNAL_IP6_NET varchar(255), IN NEW_EXTERNAL_IP_ADDR varchar(255), IN NEW_EXTERNAL_IP6_ADDR varchar(255),
  IN NEW_EXTERNAL_FQDN varchar(255), IN NEW_UPLOAD_FOLDER varchar(255),
  ...
  IN NEW_DSIP_CORE_LICENSE varbinary($HASHED_CREDS_ENCODED_MAX_LEN),
  IN NEW_DSIP_STIRSHAKEN_LICENSE varbinary($HASHED_CREDS_ENCODED_MAX_LEN),
  IN NEW_DSIP_TRANSNEXUS_LICENSE varbinary($HASHED_CREDS_ENCODED_MAX_LEN),
  IN NEW_DSIP_MSTEAMS_LICENSE varbinary($HASHED_CREDS_ENCODED_MAX_LEN)
)
BEGIN
    START TRANSACTION;
    ...
    VALUES (NEW_DSIP_ID, NEW_DSIP_CLUSTER_ID, NEW_DSIP_CLUSTER_SYNC, NEW_DSIP_PROTO, NEW_DSIP_PORT,
            ...
            NEW_DSIP_API_PORT, NEW_DSIP_PRIV_KEY, NEW_DSIP_PID_FILE, NEW_DSIP_UNIX_SOCK, NEW_DSIP_IPC_SOCK,
            NEW_DSIP_API_TOKEN,
            NEW_DSIP_LOG_LEVEL, NEW_DSIP_LOG_FACILITY, NEW_DSIP_SSL_KEY, NEW_DSIP_SSL_CERT, NEW_DSIP_SSL_CA,
            NEW_DSIP_SSL_EMAIL, NEW_DSIP_CERTS_DIR,
            ...
            NEW_KAM_CFG_PATH, NEW_KAM_TLSCFG_PATH, NEW_RTP_CFG_PATH,
            NEW_FLT_CARRIER, NEW_FLT_PBX, NEW_FLT_MSTEAMS, NEW_FLT_OUTBOUND, NEW_FLT_INBOUND, NEW_FLT_LCR_MIN,
            NEW_FLT_FWD_MIN, NEW_DEFAULT_AUTH_DOMAIN,
            ...
            NEW_HOMER_HEP_HOST, NEW_HOMER_HEP_PORT,
            NEW_IPV6_ENABLED, NEW_INTERNAL_IP_ADDR, NEW_INTERNAL_IP_NET, NEW_INTERNAL_IP6_ADDR, NEW_INTERNAL_IP6_NET,
            NEW_EXTERNAL_IP_ADDR, NEW_EXTERNAL_IP6_ADDR,
            NEW_EXTERNAL_FQDN, NEW_UPLOAD_FOLDER,
            ...
            NEW_DSIP_CORE_LICENSE, NEW_DSIP_STIRSHAKEN_LICENSE, NEW_DSIP_TRANSNEXUS_LICENSE, NEW_DSIP_MSTEAMS_LICENSE);
