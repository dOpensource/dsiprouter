...
CREATE TABLE dsip_settings (
  ...
  KAM_DB_PORT varchar(5) NOT NULL DEFAULT '3306',
  ...
  KAM_WSS_PORT varchar(5) NOT NULL DEFAULT '4443',
  KAM_SIP_PORT varchar(5) NOT NULL DEFAULT '5060',
  KAM_SIPS_PORT varchar(5) NOT NULL DEFAULT '5061',
  KAM_DMQ_PORT varchar(5) NOT NULL DEFAULT '5090',
  KAM_HEP_PORT varchar(5) NOT NULL DEFAULT '9060',
  KAM_HOMER_HOST varchar(255) NOT NULL DEFAULT '',
  ...
  FLT_MSTEAMS int NOT NULL DEFAULT 22,
  ...
  TELEBLOCK_GW_PORT varchar(5) NOT NULL DEFAULT '5066',
  TELEBLOCK_MEDIA_IP varchar(255) NOT NULL DEFAULT '',
  TELEBLOCK_MEDIA_PORT varchar(5) NOT NULL DEFAULT '',
...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_KAM_DB_DRIVER varchar(255), IN NEW_KAM_DB_TYPE varchar(255), IN NEW_KAM_DB_PORT varchar(5), IN NEW_KAM_DB_NAME varchar(255),
  IN NEW_KAM_DB_USER varchar(255), IN NEW_KAM_DB_PASS varbinary($AESCTR_CREDS_ENCODED_MAX_LEN),
  IN NEW_KAM_WSS_PORT varchar(5), IN NEW_KAM_SIP_PORT varchar(5), IN NEW_KAM_SIPS_PORT varchar(5),
  IN NEW_KAM_DMQ_PORT varchar(5), IN NEW_KAM_HEP_PORT varchar(5), IN NEW_KAM_HOMER_HOST varchar(255),
  ...
  IN NEW_TELEBLOCK_GW_IP varchar(255), IN NEW_TELEBLOCK_GW_PORT varchar(5), IN NEW_TELEBLOCK_MEDIA_IP varchar(255),
  IN NEW_TELEBLOCK_MEDIA_PORT varchar(5), IN NEW_FLOWROUTE_ACCESS_KEY varchar(255), IN NEW_FLOWROUTE_SECRET_KEY varchar(255),
...
BEGIN
  ...
  VALUES (NEW_DSIP_ID, NEW_DSIP_CLUSTER_ID, NEW_DSIP_CLUSTER_SYNC, NEW_DSIP_PROTO, NEW_DSIP_PORT,
          ...
          NEW_KAM_DB_TYPE, NEW_KAM_DB_PORT, NEW_KAM_DB_NAME, NEW_KAM_DB_USER, NEW_KAM_DB_PASS,
          NEW_KAM_WSS_PORT, NEW_KAM_SIP_PORT, NEW_KAM_SIPS_PORT, NEW_KAM_DMQ_PORT, NEW_KAM_HEP_PORT, NEW_KAM_HOMER_HOST, NEW_KAM_KAMCMD_PATH,
  ...
  IF NEW_DSIP_CLUSTER_SYNC = 1 THEN
    ...
    SET DSIP_PROTO = NEW_DSIP_PROTO,
        ...
        KAM_HEP_PORT = NEW_KAM_HEP_PORT,
        KAM_HOMER_HOST = NEW_KAM_HOMER_HOST,
