...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_DSIP_SALT binary(128), IN NEW_DSIP_IPC_PASS varbinary(128), IN NEW_DSIP_API_PROTO varchar(16),
  ...
  IN NEW_DSIP_SSL_KEY varchar(255), IN NEW_DSIP_SSL_CERT varchar(255), IN NEW_DSIP_SSL_EMAIL varchar(255), IN NEW_VERSION varchar(32),
