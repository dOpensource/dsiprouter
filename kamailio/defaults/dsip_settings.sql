...
CREATE TABLE dsip_settings (
  ...
  CHECK (CLOUD_PLATFORM IN ('', 'AWS', 'GCP', 'AZURE', 'DO', 'VULTR')),
  PRIMARY KEY (DSIP_ID)
) ENGINE = InnoDB
...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_FLOWROUTE_API_ROOT_URL varchar(255), IN NEW_IPV6_ENABLED tinyint(1), IN NEW_INTERNAL_IP_ADDR varchar(255), IN NEW_INTERNAL_IP_NET varchar(255),
  ...
  IN NEW_EXTERNAL_FQDN varchar(255), IN NEW_UPLOAD_FOLDER varchar(255), IN NEW_CLOUD_PLATFORM varchar(16),
...
BEGIN
  ...
  VALUES (NEW_DSIP_ID, NEW_DSIP_CLUSTER_ID, NEW_DSIP_CLUSTER_SYNC, NEW_DSIP_PROTO, NEW_DSIP_PORT,
          ...
          NEW_IPV6_ENABLED, NEW_INTERNAL_IP_ADDR, NEW_INTERNAL_IP_NET, NEW_INTERNAL_IP6_ADDR, NEW_INTERNAL_IP6_NET, NEW_EXTERNAL_IP_ADDR, NEW_EXTERNAL_IP6_ADDR,
          NEW_EXTERNAL_FQDN, NEW_UPLOAD_FOLDER, NEW_CLOUD_PLATFORM,
