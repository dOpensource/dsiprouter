...
CREATE TABLE dsip_settings (
  ...
  DSIP_IPC_PASS varbinary(128) COLLATE 'binary' NOT NULL,
  ...
  DSIP_IPC_SOCK varchar(255) NOT NULL DEFAULT '/var/run/dsiprouter/dsiprouter.sock',
  DSIP_API_TOKEN varbinary(128) COLLATE 'binary' NOT NULL,
...
CREATE PROCEDURE update_dsip_settings(
  IN NEW_DSIP_ID int UNSIGNED, IN NEW_DSIP_CLUSTER_ID int UNSIGNED, IN NEW_DSIP_CLUSTER_SYNC tinyint(1), IN NEW_DSIP_PROTO varchar(255),
  IN NEW_DSIP_HOST varchar(255), IN NEW_DSIP_PORT int, IN NEW_DSIP_USERNAME varchar(255), IN NEW_DSIP_PASSWORD binary(128),
  IN NEW_DSIP_SALT binary(128), IN NEW_DSIP_IPC_PASS varbinary(128), IN NEW_DSIP_API_PROTO varchar(255),
  IN NEW_DSIP_API_HOST varchar(255), IN NEW_DSIP_API_PORT int, IN NEW_DSIP_PRIV_KEY varchar(255), IN NEW_DSIP_PID_FILE varchar(255),
  IN NEW_DSIP_IPC_SOCK varchar(255), IN NEW_DSIP_API_TOKEN varbinary(128), IN NEW_DSIP_LOG_LEVEL int, IN NEW_DSIP_LOG_FACILITY int,
  IN NEW_DSIP_SSL_KEY varchar(255), IN NEW_DSIP_SSL_CERT varchar(255), IN NEW_DSIP_SSL_EMAIL varchar(255), IN NEW_VERSION varchar(255),
  IN NEW_DEBUG tinyint(1), IN NEW_ROLE varchar(255), IN NEW_GUI_INACTIVE_TIMEOUT int UNSIGNED, IN NEW_KAM_DB_HOST varchar(255),
  ...
  IN NEW_KAM_DB_USER varchar(255), IN NEW_KAM_DB_PASS varbinary(128), IN NEW_KAM_KAMCMD_PATH varchar(255),
  IN NEW_KAM_CFG_PATH varchar(255), IN NEW_RTP_CFG_PATH varchar(255), IN NEW_SQLALCHEMY_TRACK_MODIFICATIONS tinyint(1),
  IN NEW_SQLALCHEMY_SQL_DEBUG tinyint(1), IN NEW_FLT_CARRIER int, IN NEW_FLT_PBX int, IN NEW_FLT_OUTBOUND int, IN NEW_FLT_INBOUND int,
  IN NEW_FLT_LCR_MIN int, IN NEW_FLT_FWD_MIN int, IN NEW_DOMAIN varchar(255), IN NEW_TELEBLOCK_GW_ENABLED int,
  ...
  IN NEW_EXTERNAL_IP_ADDR varchar(255), IN NEW_UPLOAD_FOLDER varchar(255), IN NEW_CLOUD_PLATFORM varchar(255),
  IN NEW_MAIL_SERVER varchar(255), IN NEW_MAIL_PORT int, IN NEW_MAIL_USE_TLS tinyint(1), IN NEW_MAIL_USERNAME varchar(255),
  IN NEW_MAIL_PASSWORD varbinary(128), IN NEW_MAIL_ASCII_ATTACHMENTS tinyint(1), IN NEW_MAIL_DEFAULT_SENDER varchar(255),
...
BEGIN
  ...
  VALUES (NEW_DSIP_ID, NEW_DSIP_CLUSTER_ID, NEW_DSIP_CLUSTER_SYNC, NEW_DSIP_PROTO, NEW_DSIP_HOST, NEW_DSIP_PORT,
          NEW_DSIP_USERNAME, NEW_DSIP_PASSWORD, NEW_DSIP_SALT, NEW_DSIP_IPC_PASS, NEW_DSIP_API_PROTO, NEW_DSIP_API_HOST,
          NEW_DSIP_API_PORT, NEW_DSIP_PRIV_KEY, NEW_DSIP_PID_FILE, NEW_DSIP_IPC_SOCK, NEW_DSIP_API_TOKEN,
          NEW_DSIP_LOG_LEVEL, NEW_DSIP_LOG_FACILITY, NEW_DSIP_SSL_KEY, NEW_DSIP_SSL_CERT, NEW_DSIP_SSL_EMAIL,
          ...
          NEW_KAM_CFG_PATH, NEW_RTP_CFG_PATH, NEW_SQLALCHEMY_TRACK_MODIFICATIONS, NEW_SQLALCHEMY_SQL_DEBUG,
          NEW_FLT_CARRIER, NEW_FLT_PBX, NEW_FLT_OUTBOUND, NEW_FLT_INBOUND, NEW_FLT_LCR_MIN, NEW_FLT_FWD_MIN, NEW_DOMAIN,
          ...
          NEW_INTERNAL_IP_ADDR, NEW_INTERNAL_IP_NET, NEW_EXTERNAL_IP_ADDR, NEW_UPLOAD_FOLDER, NEW_CLOUD_PLATFORM,
