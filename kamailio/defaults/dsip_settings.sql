...
CREATE TABLE dsip_settings (
  ...
  DSIP_PASSWORD varbinary(256) COLLATE 'binary' NOT NULL,
...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_DSIP_HOST varchar(255), IN NEW_DSIP_PORT int, IN NEW_DSIP_USERNAME varchar(255), IN NEW_DSIP_PASSWORD varbinary(256),
  IN NEW_DSIP_IPC_PASS varbinary(128), IN NEW_DSIP_API_PROTO varchar(16),
...
BEGIN
  ...
  VALUES (NEW_DSIP_ID, NEW_DSIP_CLUSTER_ID, NEW_DSIP_CLUSTER_SYNC, NEW_DSIP_PROTO, NEW_DSIP_HOST, NEW_DSIP_PORT,
          NEW_DSIP_USERNAME, NEW_DSIP_PASSWORD, NEW_DSIP_IPC_PASS, NEW_DSIP_API_PROTO, NEW_DSIP_API_HOST,
