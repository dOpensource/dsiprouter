...
CREATE PROCEDURE update_dsip_settings(
  ...
  IN NEW_DSIP_HOST varchar(255), IN NEW_DSIP_PORT int, IN NEW_DSIP_USERNAME varchar(255), IN NEW_DSIP_PASSWORD varbinary($HASHED_CREDS_ENCODED_MAX_LEN),
  ...
  IN NEW_DSIP_IPC_SOCK varchar(255), IN NEW_DSIP_API_TOKEN varbinary($AESCTR_CREDS_ENCODED_MAX_LEN), IN NEW_DSIP_LOG_LEVEL int, IN NEW_DSIP_LOG_FACILITY int,
