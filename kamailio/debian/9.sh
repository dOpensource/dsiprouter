...
function install {
    ...
    apt-get install -y --allow-unauthenticated --force-yes firewalld kamailio kamailio-mysql-modules mysql-server kamailio-extra-modules kamailio-tls-modules kamailio-websocket-modules
