...
function install() {
	...
	(cat << EOF
# kamailio repo's
deb https://deb-archive.kamailio.org/repos/kamailio-${KAM_VERSION} trixie main
#deb-src https://deb-archive.kamailio.org/repos/kamailio-${KAM_VERSION} trixie main
EOF
	) > ${KAM_SOURCES_LIST}
