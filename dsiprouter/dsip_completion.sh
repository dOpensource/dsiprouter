...
_dsiprouter() {
    ...
    declare -A llopts=(
        [install]='--servernat= --external-ip= --database= --dsip-clusterid= --database-admin= --dsip-clustersync= --dsip-privkey= --with_lcr= --with_dev='
        [uninstall]=''
        [upgrade]='--release='
        [clusterinstall]=''
        [start]=''
        ...
        [generatekamconfig]=''
        [updatekamconfig]='--servernat='
        [updatertpconfig]='--servernat='
        [updatednsconfig]=''
        [help]=''
        [-h]=''
        [--help]=''
    ...
    declare -A sopts=(
        ...
        [updatekamconfig]='-debug -servernat'
