...
dSIPRouter allows you to quickly turn _`Kamailio<https://www.kamailio.org/>_` into an easy to use SIP Service Provider platform, which enables the following two basic use cases: 
