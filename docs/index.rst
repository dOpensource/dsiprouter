...
dSIPRouter allows you to quickly turn `_Kamailio <https://www.kamailio.org/>_` into an easy to use SIP Service Provider platform, which enables the following two basic use cases: 
