...
function vaultSearch() {
    local RPM_SEARCH DISTRO_MAJVER ARCH_FILTER REPO_FILTER SEARCH_RESULTS VERSIONS_TO_SEARCH SEARCH_URL
    ...
    for VAULT_VER in ${VERSIONS_TO_SEARCH[@]}; do
        SEARCH_URL="https://repo.almalinux.org/vault/${VAULT_VER}/${REPO_FILTER}/${ARCH_FILTER}/os/Packages/${RPM_SEARCH}.rpm"
